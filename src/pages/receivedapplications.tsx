...
const Receivedapplications = () => {
  ...
  const totalLoanAmount = field.reduce(
    (total, data) => total + parseInt(data[2]),
    0
  );
  ...
  return (
    <div className="bg-[#140506] text-center">
      <Header />
      <h1 className="mt-20 bg-[#140506] py-10 text-center text-3xl font-bold text-green-700">
      ...
      <div className="overflow-x-scroll px-5 pb-5 md:mx-20 md:overflow-hidden">
        <table className="md:ml-20 ">
          <tr className="space-x-5 border-2 border-white text-2xl text-green-300">
